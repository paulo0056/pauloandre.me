export const pt_BR = {
  ...
  contact: "Contato",
  hello: "Olá",
  my_name_is: "Eu me chamo Paulo André",
  profile:
  ...
  tecno_system_description:
    "Desenvolvimento de sites com wordpress e programação dossistemas da empresa desde a modelagem de banco de dados atéa programação de back end e front end com Php, react e MySql, alem de participar do gerenciamento de projetos eacompanhamento de trainees.",
  president_description:
    " Criação de planejamento estratégico, controle financeiro, gestão de pessoas, atividades administrativas da empresa e gerenciamento de projetos",
  president: "Presidente",
  cattle_description: "Site catalogo de vendas de gados",
  tecno_system_site_description: "Site da empresa junior Tecno System",
  pokedex_site_description: "Uma pokedex feita com Vue js",
  memorygame_site_description: "Um jogo da memoria do anime One Piece",
  ...
  javascript_calculator: "Uma calculadora em javascript",
  pauloandre_repo: "Repositorio do meu site de apresentação",
